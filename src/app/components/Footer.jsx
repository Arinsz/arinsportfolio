  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          ...
          <video
            ...
            muted
            onEnded={() => {
              // Remove the onEnded handler or keep it empty to do nothing
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/arin.sz.5/"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/arinsarafraz/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Arin</p>
        <div className="footer--social--icon">
          <ul>
            <li>
